        ...
        <g:form class="form-horizontal" name="frmTest" role="form" action="save_ajax" method="POST">
            ...
            <div class="form-group keeptogether ${hasErrors(bean: testInstance, field: 'email', 'error')} required">
                <span class="grupo">
                    ...
                    <div class="col-md-7">
                        ...
                        </span><g:field type="email" name="email" required="" class="form-control required unique noEspacios" value="${testInstance?.email}"/>
                        </div>
                    </div>
                    *
                </span>
            ...
            <div class="form-group keeptogether ${hasErrors(bean: testInstance, field: 'fechaHora', 'error')} required">
                <span class="grupo">
                    ...
                    <div class="col-md-5">
                        <elm:datepicker showTime="true" showSec="true" name="fechaHora" class="datepicker form-control required" value="${testInstance?.fechaHora ?: new Date()}"/>
                    </div>
                    *
                </span>
            </div>
            ...
            <div class="form-group keeptogether ${hasErrors(bean: testInstance, field: 'mail', 'error')} required">
                <span class="grupo">
                    ...
                    <div class="col-md-7">
                        <div class="input-group"><span class="input-group-addon"><i class="fa fa-envelope"></i>
                        </span><g:field type="email" name="mail" required="" class="form-control required unique noEspacios" value="${testInstance?.mail}"/>
                        </div>
                    </div>
                    *
                </span>
            ...
            <div class="form-group keeptogether ${hasErrors(bean: testInstance, field: 'password', 'error')} required">
                <span class="grupo">
                    ...
                    <div class="col-md-7">
                        ...
                        </span><g:field type="password" name="password" required="" class="form-control required" value="${testInstance?.password}"/>
                        </div>
                    </div>
                    *
                </span>
