...
<html>
    ...
    <!-- botones -->
            ...
            <div class="btn-group pull-right col-md-3">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <g:link controller="actividad" action="list" class="btn btn-default btn-search">
        ...
        <table class="table table-condensed table-bordered table-striped table-hover">
            ...
            <tbody>
                <g:if test="${actividadInstanceCount > 0}">
                    <g:each in="${actividadInstanceList}" status="i" var="actividadInstance">
                        <tr data-id="${actividadInstance.id}">
                            
                            <td>${actividadInstance.codigo}</td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${actividadInstance}" field="descripcion"/></elm:textoBusqueda></td>
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    ...
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>" +
                              "¿Está seguro que desea eliminar el Actividad seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
