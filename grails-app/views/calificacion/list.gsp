            ...
            <div class="btn-group pull-right col-md-3">
                <div class="input-group input-group-sm">
                    ...
                    <span class="input-group-btn">
                        <g:link controller="calificacion" action="list" class="btn btn-default btn-search">
        ...
        <script type="text/javascript">
            ...
            function submitForm() {
                ...
                if ($form.valid()) {
                    ...
                    openLoader("Guardando Calificacion");
                    $.ajax({
                        type    : "POST",
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    ...
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>" +
                              "¿Está seguro que desea eliminar el Calificacion seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
                        ...
                        eliminar : {
                            ...
                            callback  : function () {
                                openLoader("Eliminando Calificacion");
                                $.ajax({
                                    type    : "POST",
