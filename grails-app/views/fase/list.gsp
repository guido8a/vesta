            ...
            <div class="btn-group pull-right col-md-3">
                <div class="input-group">
                    ...
                    <span class="input-group-btn">
                        <g:link controller="fase" action="list" class="btn btn-default btn-search">
            ...
            function deleteRow(itemId) {
                bootbox.dialog({
                    ...
                    message : "<i class='fa fa-trash-o fa-3x pull-left text-danger text-shadow'></i><p>" +
                              "¿Está seguro que desea eliminar el Fase seleccionado? Esta acción no se puede deshacer.</p>",
                    buttons : {
                        cancelar : {
                            label     : "Cancelar",
