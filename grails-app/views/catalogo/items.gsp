...
<div style="width:960px; margin-bottom:5px; margin-top:10px; padding: 4px;" class="ui-corner-all ui-widget-content">
    ...
    <input class="modulo" type="button" id="creaCtlg" name="modulo" value="Crear Catálogo"/>
    <input class="modulo" type="button" id="editCtlg" name="modulo" value="Editar Catálogo"/>
    <input class="modulo" type="button" id="borraCtlg" name="modulo" value="Borrar Catálogo"/>

    <span style="font-size: 10pt; color: black; margin-left: 20px;">Seleccione un Catálogo
    <g:select optionKey="id" from="${vesta.parametros.Catalogo.list([sort: 'nombre'])}" name="catalogo"
