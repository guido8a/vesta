                ...
                <g:if test="${unidadEjecutoraInstanceCount > 0}">
                    <g:each in="${unidadEjecutoraInstanceList}" status="i" var="unidadEjecutoraInstance">
                        <tr data-id="${unidadEjecutoraInstance.id}">
                            ...
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${unidadEjecutoraInstance}" field="provincia"/></elm:textoBusqueda></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${unidadEjecutoraInstance}" field="codigo"/></elm:textoBusqueda></td>
                            
                            <td><g:formatDate date="${unidadEjecutoraInstance.fechaInicio}" format="dd-MM-yyyy" /></td>
                            
                            <td><g:formatDate date="${unidadEjecutoraInstance.fechaFin}" format="dd-MM-yyyy" /></td>
                            ...
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${unidadEjecutoraInstance}" field="direccion"/></elm:textoBusqueda></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${unidadEjecutoraInstance}" field="sigla"/></elm:textoBusqueda></td>
                            
                            <td><elm:textoBusqueda busca="${params.search}"><g:fieldValue bean="${unidadEjecutoraInstance}" field="objetivo"/></elm:textoBusqueda></td>
