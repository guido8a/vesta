        ...
        <div class="hoja">
            ...
            <div style="text-align: justify;float: left;font-size: 10pt;">
                <p>
                    ...
                    por un monto total de <g:formatNumber number="${sol.monto}" type="currency"/>$, con base en cual informo lo siguiente:
                </p>
                ...
                <table style="width: 100%">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <g:formatNumber number="${sol.monto + ((anterior) ? anterior?.monto : 0)}" type="currency"/>
                            </td>
                        </tr>
                    </tbody>
                </table>
                <g:each in="${ProcesoAsignacion.findAllByProceso(sol.proceso)}" var="pa">
                    <table style="width: 100%;margin-top: 15px">
                        ...
                        <tr>
                            ...
                            <td><g:formatNumber number="${pa.monto}" type="currency"/></td>
                        </tr>
                    </table>
                </g:each>
