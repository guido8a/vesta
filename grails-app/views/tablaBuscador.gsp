                    ...
                    <g:each var="reg" in="${lista}" status="i">
                        ...
                        <tr style="font-size: 10px !important;">
                            <td style="text-align: right;width: 50px">
                                <a class="ok btn btn-small btn-success btn-ajax btn-xs" href="#" rel="tooltip" style="margin-right: 5px" title="Seleccionar" id="reg_${i}" regId="${reg?.id}" txtReg="${reg.toString()}" ${propiedades}>
