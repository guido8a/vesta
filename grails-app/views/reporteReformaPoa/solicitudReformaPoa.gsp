            ...
            <ol>
                ...
                <li style="margin-left: 20px">
                    ...
                    <table style="width:100%;" class="table " border="1">
                         <thead>
                        <tr>
                            <th style="background: #b6e2ff">Proyecto</th>
                            <th style="background: #b6e2ff">Componente</th>
                            <th style="background: #b6e2ff">No</th>
                            <th style="background: #b6e2ff">Actividad</th>
                            <th style="background: #b6e2ff">
                                Grupo de <br/>
                                gasto
                            </th>
                            <th style="background: #b6e2ff">Valor inicial</th>
                            <th style="background: #b6e2ff">Disminución</th>
                            <th style="background: #b6e2ff">Aumento</th>
                            <th style="background: #b6e2ff">Valor final</th>
                        </tr>
                        </thead>
                        <tbody>
                        <tr>
                ...
                <div>
                    <span class="spanFirma">
                        <g:if test="${sol?.firmaSol?.estado=='F'}">
                            ...
                            f) <div style="border-bottom: thin"> </div>
