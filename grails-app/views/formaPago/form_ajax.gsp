...
<g:else>
    ...
    <g:form class="form-horizontal" name="frmFormaPago" role="form" action="save_ajax" method="POST">
        <g:hiddenField name="id" value="${formaPagoInstance?.id}" />

        
        <div class="form-group keeptogether ${hasErrors(bean: formaPagoInstance, field: 'descripcion', 'error')} required">
            <span class="grupo">
    ...
    <script type="text/javascript">
        var validator = $("#frmFormaPago").validate({
