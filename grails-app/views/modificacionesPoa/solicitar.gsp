    ...
    <g:form action="save" class="frmProceso">
        <div class="row">
            ...
            <div class="col-md-2" id="">
                <g:select from="${vesta.parametros.poaPac.Anio.list([sort: 'anio'])}" value="${actual?.id}" optionKey="id" optionValue="anio" id="anio" name="anio"  class="form-control input-sm"></g:select>
            </div>
        </div>
        <div class="row">
            <div class="col-md-1">
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="div_comp">
                <g:select from="${[]}"  name="comp" id="comp" noSelection="['-1': 'Seleccione...']" style="width: 100%"  class="form-control input-sm"></g:select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="divAct">
                <g:select from="${[]}" id="actividad" name="actividad" style="width:100%" noSelection="['-1': 'Seleccione']"  class="form-control input-sm"></g:select>
            </div>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-10" id="divAsg">
                <g:select from="${[]}" id="asignacion" name="origen.id" style="width:100%" noSelection="['-1': 'Seleccione']"  class="form-control input-sm"></g:select>
            </div>
        </div>
...
<elm:container tipo="horizontal" titulo="Firma" style="">
    <div class="row" style="margin-bottom: 10px">
        ...
        <div class="col-md-3">
            <g:select from="${vesta.seguridad.Persona.findAllByUnidad(session.usuario.unidad,[sort:'nombre'])}" optionKey="id"  optionValue=""  id="firma" name="firma" class="form-control input-sm" ></g:select>
        </div>
    </div>
</elm:container>
<div role="tabpanel" style="margin-top: 20px">
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active"><a href="#reasignar" aria-controls="reasignar" role="tab" data-toggle="tab">Actividad existente</a></li>
        <li role="presentation"><a href="#nueva" aria-controls="nueva" role="tab" data-toggle="tab">Nueva actividad</a></li>
        <li role="presentation"><a href="#derivada" aria-controls="derivada" role="tab" data-toggle="tab">Nueva partida</a></li>
        <li role="presentation"><a href="#aumentar" aria-controls="aumentar" role="tab" data-toggle="tab">Incremento</a></li>
    </ul>
        ...
        <div role="tabpanel" class="tab-pane active" id="reasignar">
            <elm:container tipo="horizontal" titulo="Asignación de destino." style="">
                <div class="row">
                    ...
                    <div class="col-md-2">
                        <g:select from="${vesta.parametros.poaPac.Anio.list([sort: 'anio'])}" value="${actual?.id}" optionKey="id" optionValue="anio" id="anio_dest" name="anio" class="form-control input-sm" ></g:select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10">
                        <g:select from="${vesta.proyectos.Proyecto.list([sort: 'nombre'])}" optionKey="id" optionValue="nombre" name="proyecto.id" id="proyectoDest" style="width:100%" class="form-control input-sm" value="${proceso?.proyecto?.id}"  noSelection="['-1': 'Seleccione...']" ></g:select>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-md-10" id="div_comp_dest">
                        <g:select from="${[]}"  name="comp" id="compDest" noSelection="['-1': 'Seleccione...']" style="width: 100%" class="form-control input-sm"></g:select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" id="divAct_dest">
                        <g:select from="${[]}" id="actividad_dest" name="actividad" style="width:100%" noSelection="['-1': 'Seleccione']" class="form-control input-sm"></g:select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" id="divAsg_dest">
                        <g:select from="${[]}" id="asignacion_dest" name="origen.id" style="width:100%" noSelection="['-1': 'Seleccione']" class="form-control input-sm"></g:select>
                    </div>
                </div>
                <div class="row">
        ...
        <div role="tabpanel" class="tab-pane" id="nueva">
            <elm:container tipo="horizontal" titulo="Nueva asignación." style="">
                <div class="row">
                    <div class="col-md-1">POA año:</div>
                    <div class="col-md-2">
                        <g:select from="${vesta.parametros.poaPac.Anio.list([sort: 'anio'])}" value="${actual?.id}" optionKey="id" optionValue="anio" id="anio_nueva" name="anio" class="form-control input-sm" ></g:select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-10" >
                        <g:select from="${vesta.parametros.poaPac.Fuente.list([sort:'descripcion'])}" id="fuente" name="fuente"  class="form-control input-sm" optionKey="id" optionValue="descripcion" ></g:select>
                    </div>
                </div>
                <div class="row">
