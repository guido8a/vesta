                ...
                <table class="table table-condensed table-bordered table-striped table-hover">
                    ...
                    <g:each in="${solicitudes}" var="p">
                        <tr data-id="${p?.id}">
                            ...
                            <td style="text-align: center">
                                <a href="${g.createLink(controller: 'modificacionesPoa',action: 'verSolicitud',id:p.id)}" class="btn btn-success btn-sm" iden="${p.id}" title="Aprobar o Negar"><i class="fa fa-gear"></i> Procesar</a>
                            </td>
