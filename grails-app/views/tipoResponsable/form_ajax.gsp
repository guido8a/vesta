    ...
    <g:form class="form-horizontal" name="frmTipoResponsable" role="form" action="save_ajax" method="POST">
        ...
        <div class="form-group keeptogether ${hasErrors(bean: tipoResponsableInstance, field: 'codigo', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="codigo" maxlength="1" required="" class="form-control required unique noEspacios" value="${tipoResponsableInstance?.codigo}"/>
                </div>
                 *
            </span>
        </div>
        ...
        <div class="form-group keeptogether ${hasErrors(bean: tipoResponsableInstance, field: 'descripcion', 'error')} required">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="descripcion" maxlength="15" required="" class="form-control required" value="${tipoResponsableInstance?.descripcion}"/>
                </div>
                 *
            </span>
        </div>
