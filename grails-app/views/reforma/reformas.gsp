...
<html>
    ...
    <body>
        ...
        <g:link action="existente" class="btn btn-default bgExistentes" style="width: 370px; text-align: left; font-size: large; font-weight: bolder; margin-bottom: 10px; margin-left: 300px" title="Traspaso de recursos del área  entre actividades y partidas presupuestarias existentes"> 1.- Reasignación de recursos existentes </g:link> <br>
        <g:link action="partida" class="btn btn-default bgPartidas" style="width: 370px; text-align: left; font-size: large; font-weight: bolder; margin-bottom: 10px; margin-left: 300px" title="Modificación en la distribución de los recursos de la actividad hacia nuevas partidas presupuestarias ">2.- Inclusión de nuevas partidas presupuestarias</g:link> <br>
        <g:link action="actividad" class="btn btn-default bgActividades"  style="width: 370px; text-align: left;  font-size: large; font-weight: bolder; margin-bottom: 10px; margin-left: 300px" title="Selección de la actividad existente para la que se requiere asignación o incremento de recursos">3.- Actividad existente sin financiamiento </g:link> <br>
        <g:link action="incrementoActividad" class="btn btn-default bgActividades2"   style="width: 370px; text-align: left;  font-size: large; font-weight: bolder; margin-bottom: 10px; margin-left: 300px" title="Creación de una nueva actividad con asignación de recursos de otra actividad del área">4.- Creación de una nueva actividad </g:link> <br>
        <g:link action="incremento" class="btn btn-default bgIncremento"  style="width: 370px; text-align: left;  font-size: large; font-weight: bolder; margin-bottom: 10px; margin-left: 300px" title="Creación de una nueva actividad para la que se requiere asignación de recursos ">5.- Creación de una nueva actividad sin financiamiento</g:link>
        </div>
        </elm:container>
