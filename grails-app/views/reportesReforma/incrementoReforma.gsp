      ...
      <li>
        ...
        <table style="width:100%;margin-top: 15px" class="table " border="1">
          ...
          <g:each in="${modificaciones}" var="modificacion">
            <g:set var="totalInicial" value="${totalInicial + ( modificacion.detalleReforma.asignacionOrigen.priorizado+ modificacion.detalleReforma.valor + modificacion.detalleReforma.asignacionDestino.priorizado- modificacion.detalleReforma.valor)}"/>
            ...
            <g:set var="totalFinal" value="${totalFinal + (modificacion.detalleReforma.asignacionOrigen.priorizado  + modificacion.detalleReforma.asignacionDestino.priorizado)}"/>
            <tr class="info">
              <td>
