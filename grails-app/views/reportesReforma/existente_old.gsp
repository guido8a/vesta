...
<html>
    ...
    <body>
        ...
        %{--<li class="no-break">--}%
        %{--<g:if test="${reforma?.tipo == 'R'}">--}%
        %{--<strong>Tipo de reforma:</strong> Reforma entre actividades por reasignación de recursos o saldos--}%
        ...
        %{--</g:if>--}%
        %{--<g:else>--}%
        %{--<strong>Tipo de ajuste:</strong> Ajuste entre actividades por reasignación de recursos o saldos--}%
        %{--<table class="table " border="1" style="margin-left: 280px">--}%
        %{--<thead>--}%
        %{--<tr>--}%
        %{--<th style="text-align: center">Detalle</th>--}%
