...
<html>
    ...
    <!-- botones -->
            ...
            <div class="btn-group pull-right col-md-3">
                <div class="input-group input-group-sm">
                    ...
                    <span class="input-group-btn">
                        <g:link controller="aval" action="list" class="btn btn-default btn-search">
        ...
        <elm:pagination total="${avalInstanceCount}" params="${params}"/>
