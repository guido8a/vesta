    ...
    <g:form class="form-horizontal" name="frmUnidad" role="form" action="save_ajax" method="POST">
        ...
        <div class="form-group keeptogether ${hasErrors(bean: unidadInstance, field: 'codigo', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="codigo" maxlength="7" class="form-control unique noEspacios" value="${unidadInstance?.codigo}"/>
                </div>
        ...
        <div class="form-group keeptogether ${hasErrors(bean: unidadInstance, field: 'descripcion', 'error')} ">
            <span class="grupo">
                ...
                <div class="col-md-6">
                    <g:textField name="descripcion" maxlength="63" class="form-control" value="${unidadInstance?.descripcion}"/>
                </div>
