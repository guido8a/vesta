...
<elm:container tipo="horizontal" titulo="Programación de las asignaciones del proyecto: ${proyecto?.toStringLargo()}, para el año ${actual}" color="black" >
    <table  class="table table-condensed table-bordered table-striped">
        ...
        <tr>
            <td style="text-align: center"><g:formatNumber number="${ene}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${feb}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${mar}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${abr}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${may}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${jun}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${jul}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${ago}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${sep}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${oct}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${nov}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${dic}" type="currency"/></td>
            <td style="text-align: center"><g:formatNumber number="${ene.toDouble()+feb.toDouble()+mar.toDouble()+abr.toDouble()+may.toDouble()+jun.toDouble()+jul.toDouble()+ago.toDouble()+sep.toDouble()+oct.toDouble()+nov.toDouble()+dic.toDouble()}" type="currency"/></td>
        </tr>
        </tbody>
    </table>
</elm:container>
